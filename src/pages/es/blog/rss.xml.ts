...
export function GET(context: APIContext) {
  ...
  return rss({
    ...
    description: 'Artículos sobre ciberseguridad, infraestructura e ingeniería de IA.',
    site: context.site!,
    items,
